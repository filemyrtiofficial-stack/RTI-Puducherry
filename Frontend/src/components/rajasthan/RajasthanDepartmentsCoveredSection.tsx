...
export const RajasthanDepartmentsCoveredSection: React.FC = () => {
  ...
  const departments = [
    "Health & Family Welfare", "School Education", "Higher Education", "Revenue Department",
    "District Collectorate", "Registration Department", "Public Works Department", "Electricity Department",
    "Home Department", "Police Department", "Local Administration", "Agriculture Department",
    "Industries & Commerce", "Labour Department", "Social Welfare", "Transport Department",
    "Finance Department", "Forest Department", "Information Technology", "State Information Commission"
  ];
      ...
      <div className="container-responsive max-w-7xl mx-auto px-4">
        <AnimatedSection animation="fadeIn" delay={200}>
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-serif font-semibold text-gray-900 tracking-wide mb-6">Puducherry Departments Covered</h2>
            <p className="text-base md:text-lg font-normal text-gray-600 max-w-2xl mx-auto leading-relaxed">
              We handle RTI applications across all Puducherry government departments with state-specific expertise.
            </p>
          </div>
        </AnimatedSection>
